...
try:
	...
	f_ID.write("Total_ID: %d, TP: %d, FP: %d" %(countAge, countAge_tp, countAge_fp))
	...
	f_Position.write("Total_Telephone: %d, TP: %d, FP: %d" %(countTelephone, countTelephone_tp, countTelephone_fp))
